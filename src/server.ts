...
server.registerTool(
  "new_project",
  {
    ...
    outputSchema: {
      ...
      projectDir: z.string(),
      diagnostics: z.array(
        z.object({ level: z.string(), field: z.string(), message: z.string() })
      ),
    },
  },
...
server.registerResource(
  "project-file",
  new ResourceTemplate("project://{projectId}/{fileName}", { list: undefined }),
  {
    title: "Project File",
    description: "Read generated project files from the Typst GOST workspace.",
  },
